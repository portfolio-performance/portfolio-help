...
Figure: The Reports > Performance > Trades view (<a href="https://raw.githubusercontent.com/portfolio-performance/portfolio-help/c66b7b82c0db5e57279a2bfde6ff2d3f5ddb1bf6/docs/en/assets/demo.xml" download="demo.xml">download sample XML file</a>). {class=pp-figure}
