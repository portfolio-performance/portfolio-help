...
![](images/info-irr-caluclation-securities.png)
...
![](images/info-irr-caluclation-securities-multiple-transactions.png)
...
`190.06 = 153 x (1+IRR)^(878/365) + 83 x (1+IRR)^(514/365) - 30 x (1+IRR)^(179/365) - 107 x (1 + IRR)^(61/365)` As can be seen from Figure 7, the IRR = 18.00%.
